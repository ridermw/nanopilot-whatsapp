...
React to messages with emoji using the `mcp__nanopilot__react_to_message` tool.
...
```
mcp__nanopilot__react_to_message(emoji: "👍")
```
...
```
mcp__nanopilot__react_to_message(emoji: "❤️", message_id: "3EB0F4C9E7...")
```
