...
<html><head><title>NanoPilot - WhatsApp Auth</title>
...
<script>
  var startKey = 'nanopilot_qr_start';
...
<html><head><title>NanoPilot - Connected!</title>
<style>
...
<script>localStorage.removeItem('nanopilot_qr_start');</script>
</body></html>`;
